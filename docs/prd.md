...
* **RF-53.** Toda coleta e seleção interativa de uma jornada roda em um programa full-screen (buffer alternativo); ao encerrar, o buffer primário é restaurado e os recibos das etapas aceitas são reimpressos nele. Ao aceitar uma etapa, o controle ativo é substituído por um recibo compacto com título, marca de sucesso e valor aceito; valores sensíveis devem ser redigidos ou omitidos.
